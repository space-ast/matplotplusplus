...
namespace matplot {
    ...
    class MATPLOT_EXPORTS axis_type {
      ...
      public:
        ...
        class axis_type &color(matplot::string_view color);
        class axis_type &color(const enum color &color);

        const std::string &label() const;
        class axis_type &label(matplot::string_view label);

        const std::string &tick_label_format() const;
        class axis_type &tick_label_format(matplot::string_view tick_label_format);
        ...
        class axis_type &label_weight(matplot::string_view label_weight);
