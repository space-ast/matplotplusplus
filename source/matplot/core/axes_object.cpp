...
namespace matplot {
    ...
    std::string axes_object::legend_string(matplot::string_view title) {
    ...
    void axes_object::tag(matplot::string_view tag_name) { tag_ = tag_name; }
    ...
    void axes_object::display_name(matplot::string_view display_name) {
