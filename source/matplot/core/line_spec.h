...
namespace matplot {
    class MATPLOT_EXPORTS line_spec {
      ...
      public:
        line_spec();
        explicit line_spec(matplot::string_view expr);

        template <class T>
        line_spec(Pointer<T> parent, matplot::string_view expr)
            : line_spec(expr) {
      ...
      public:
        ...
        void parse_string(matplot::string_view expr);
        ...
        void marker_color(matplot::string_view color);
        ...
        void marker_face_color(matplot::string_view color);
