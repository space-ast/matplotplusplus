...
namespace matplot {
    ...
    std::string bars::legend_string(matplot::string_view title) {
        std::string res;
        for (size_t i = 0; i < ys_.size(); ++i) {
    ...
    class bars &bars::face_color(matplot::string_view color) {
    ...
    class bars &bars::edge_color(matplot::string_view color) {
