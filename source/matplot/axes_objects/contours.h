...
namespace matplot {
    ...
    class MATPLOT_EXPORTS contours : public axes_object {
      ...
      public /* getters and setters */:
        class contours &line_style(matplot::string_view line_spec);
        ...
        class contours &font(matplot::string_view font);

        const std::string &font_weight() const;
        class contours &font_weight(matplot::string_view font_weight);

        const color_array &font_color() const;
        class contours &font_color(const color_array &font_color);
        class contours &font_color(matplot::string_view font_color);
